...
import com.netty.study.server.handler.HeartbeatHandler;
import com.netty.study.server.handler.ServiceHandler;
...
public class NettyChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        if (context != null) {
            ...
            sslHandler.setCloseNotifyTimeout(30, TimeUnit.SECONDS);
